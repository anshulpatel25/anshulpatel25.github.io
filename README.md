...
This repository contains the source code for [anshulpatel.in](https://www.anshulpatel.in), a personal website and blog built with [Hugo](https://gohugo.io/).
...
- **Theme:** [Hugo Coder](https://github.com/luizdepra/hugo-coder) (as a Hugo module)
- **3D Visualization:** [Three.js](https://threejs.org/) for rendering STL models.
...
For instructions on contributing or working with this repository as an AI agent, please refer to [AGENTS.md](./AGENTS.md).
